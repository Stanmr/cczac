...
define('SWM_THEME_VERSION', '1.17');

define('SWM_VISUAL_COMOPSER_IS_ACTIVE', class_exists( 'Vc_Manager' ));
define('SWM_REVOLUTION_SLIDER_IS_ACTIVE', class_exists( 'RevSlider' ));
define('SWM_WOOCOMMERCE_IS_ACTIVE', class_exists( 'WC_API' ));
define('SWM_TRIBE_EVENTS_IS_ACTIVE', class_exists( 'Tribe__Events__Main' ));
define('SWM_TRIBE_EVENTS_PRO_IS_ACTIVE', class_exists( 'TribeEventsPro' ));
define('SWM_WPML_IS_ACTIVE', class_exists( 'SitePress' ));
	...
	function swm_load_scripts () {
		if ( !is_admin() ) {			
            ...
            $google_fonts_add_list = array(
                'family' => swm_output_google_font_url('swm_body_font_family','swm_body_font_weight',',italic,700,700italic%7C',$swm_body_sf). swm_output_google_font_url('swm_top_nav_font_family','swm_top_nav_font_weight','%7C',$swm_top_nav_sf) . swm_output_google_font_url('swm_headings_font_family','swm_headings_font_weight','',$swm_headings_sf),
                'subset' => $subsets,
            );          
