...
function swm_add_customizer_menu() {
  add_menu_page( esc_html__('Customizer','election'), esc_html__('Customizer','election'), 'edit_theme_options', 'customize.php', NULL, NULL,59);
  add_submenu_page( 'customize.php', esc_html__('Customizer Import','election'), esc_html__('Import','election'), 'edit_theme_options', 'import', 'swm_customizer_import_page' );
  add_submenu_page( 'customize.php', esc_html__('Customizer Export','election'), esc_html__('Export','election'), 'edit_theme_options', 'export', 'swm_customizer_export_page' );
}
